                ...
                <div className="container g-4">
                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <div className='navbar-nav d-flex justify-content-between w-50'>
                            <a className='warehouse nav-item text-decoration-none' href='#properties'>Avenues</a>
                            <a className='warehouse nav-item text-decoration-none' href="#reviews">Contact Us</a>
                            <Link
